...
| H5P (mod\_h5pactivity / .h5p files) | ✅ metadata + package       | ⚠️ experimental playback | sandboxed player, self-contained packages; see ADR-0017 — unsupported content types fall back to download       |
