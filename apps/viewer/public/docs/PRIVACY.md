> For AI agents: the complete documentation index is available at /mbzoo/docs/llms.txt, the full documentation bundle is available at /mbzoo/docs/llms-full.txt, and this page is available as Markdown at /mbzoo/docs/PRIVACY.md.
...
with _user data included_ carries a root `users.xml`, and it is not a list of
...
own download folder. See [Activity support](/mbzoo/docs/guide/activity-support.md).
