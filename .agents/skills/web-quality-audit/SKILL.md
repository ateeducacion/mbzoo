...
description: Audit MBZoo viewer quality across performance, accessibility, privacy, resilience and browser behavior. Use when asked to audit viewer quality or assess release readiness.
---
...
- Security: backup content is hostile. Sanitized in-app HTML and sandboxed executable previews must follow ADR-0012 and the preview-specific policies in `mbz-content-sandbox`; load `mbz-security` for findings at trust boundaries.
